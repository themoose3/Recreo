...
class ChatViewController: JSQMessagesViewController {
    ...
    private lazy var messageRef: FIRDatabaseReference = self.eventRef!.child("messages")
    ...
    private func observeMessages() {
        messageRef = (eventRef?.child("messages"))!
        // 1.
    ...
    private func observeTyping() {
        let typingIndicatorRef = eventRef?.child("typingIndicator")
